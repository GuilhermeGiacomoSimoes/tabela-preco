...
function construirTabelaDeLentes(array){
	...
	for (let key in array){
		...
		<div style="background-color: ${background_line}">
			<span class="description"style="margin-left: 10%; width: 15%"> ${lente['descricao']}</span>
			...
			<span class="description" style="margin-left: 8%; width: 4%; color: ${color}"; > R$ ${lente['preco']} </span>
			<span class="description" style="margin-left: 6%; width: 5%; color: ${color}"; > R$ ${lente['venda']} </span>
